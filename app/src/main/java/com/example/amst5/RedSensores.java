            ...
            new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        ...
                        tempValue.setText(String.format("%s °C", response.getString("temperatura")));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
            ...
            JsonObjectRequest request_humedad = new JsonObjectRequest(
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        System.out.println(response);
                        try {
                            humedadValue.setText(String.format("%s %%", response.getString("humedad")));
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
            ...
            JsonObjectRequest request_peso = new JsonObjectRequest(
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        System.out.println(response);
                        try {
                            pesoValue.setText(String.format("%s g", response.getString("peso")));
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
